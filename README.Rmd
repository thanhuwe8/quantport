...
We will express our subjective views through matrix `P` and vector `Q`. The first view is that the 1st asset will outperform  the 3rd asset by 1%. The second view is that that 3rd asset will have mean return of 3%. Then we formulate the views as below:
